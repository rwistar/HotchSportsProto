//
//  ScoreFilterTableViewController.swift
//  HotchSportsProto
//
...
protocol ScoreFilterDelegate: class {
    func updateScoreTable(teamFlags: [String: Bool])
}

class ScoreFilterTableViewController: UITableViewController {

    var teamFlags: [String: Bool]?
    
    weak var delegate: ScoreFilterDelegate?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tableItemScoreFilter", for: indexPath)
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        if let flags = teamFlags {
            delegate?.updateScoreTable(teamFlags: flags)
        }
    }
